...
def list_cold_archives():
    ...
    try:
        ...
        return jsonify({"archives": archives, "count": len(archives)}), 200
...
def get_cold_archive_info(archive_id: str):
    ...
    try:
        ...
        if not archive:
            return jsonify(
                {"error": "Not Found", "message": f"Archive {archive_id} not found"}
            ), 404
...
def retrieve_cold_archive(archive_id: str):
    ...
    try:
        ...
        return jsonify(
            {"success": True, "archive_id": archive_id, "local_path": restore_path}
        ), 200
...
def delete_cold_archive(archive_id: str):
    ...
    try:
        ...
        return jsonify(
            {"success": True, "message": "Archive deleted successfully"}
        ), 200
